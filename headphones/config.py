...
_CONFIG_DEFINITIONS = {
	...
	'MANICOMIOSHARE': (int, 'ManicomioShare', 0),
    'MANICOMIOSHARE_PROXY_URL': (str, 'ManicomioShare', ''),
    'MANICOMIOSHARE_RATIO': (str, 'ManicomioShare', ''),
	'MANICOMIOSHARE_UID': (str, 'ManicomioShare', ''),
    'MANICOMIOSHARE_PASSKEY': (str, 'ManicomioShare', ''),
